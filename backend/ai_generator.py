...
class AIGenerator:
    """Handles interactions with a local Ollama LLM via OpenAI-compatible API"""
...
"""
    ...
    def _handle_tool_execution(self, assistant_message, messages: List, tool_manager) -> str:
        """
